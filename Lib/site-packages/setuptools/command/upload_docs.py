...
class upload_docs(upload):
    ...
    description = 'Uploads documentation to sites other than PyPi such as devpi'
    ...
    def upload_file(self, filename):
        ...
        if r.status == 200:
            ...
            msg = 'Uploads successful. Visit %s' % location
            self.announce(msg, log.INFO)
        else:
            msg = 'Uploads failed (%s): %s' % (r.status, r.reason)
